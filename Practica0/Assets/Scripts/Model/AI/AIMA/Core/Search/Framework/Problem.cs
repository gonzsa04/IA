namespace AIMA.Core.Search.Framework
{
     ...
     */
        ...
        // CAMBIAR NOMBRES A TODO ESTO PARA LLAMARLO CONFIGURACIONES (incluye CONFIGURACIÓN INICIAL), OPERADORES, MODELO TRANSICIÓN, PRUEBA DE OBJETIVO y COSTE DE RUTA
    ...
    public class Problem
    {
        ...
        protected Object initialSetup; //instead of initialState

        protected OperatorsFunction operatorsFunction; // instead of actionsFunction

        protected ResultFunction resultFunction; // this is transitionsFunction

        protected GoalTest goalTest;

        protected StepCostFunction stepCostFunction; // path cost

        public Problem(Object initialState, OperatorsFunction actionsFunction,
        ...
        {
            this.initialSetup = initialState;
            this.operatorsFunction = actionsFunction;
