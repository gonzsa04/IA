...
namespace UCM.IAV.Puzzles.Model {
    ...
    public class Position {
        ...
        public Position(int row, int column) {
            ...
            if (row == Int32.MaxValue) throw new ArgumentException(string.Format("{0} is not a valid row", row), "row");
            if (column == Int32.MaxValue) throw new ArgumentException(string.Format("{0} is not a valid column", column), "column");
        ...
        */
        ...
        public bool IsUp(Position position) {
            return column == position.column && row + 1 == position.row;
        }
        ...
        public bool IsDown(Position position) {
            return column == position.column && position.row + 1 == row;
        }
        ...
        public Position Down() {
            if (row + 1 == Int32.MaxValue) throw new InvalidOperationException("The required position is not accessible");
        ...
        public bool IsLeft(Position position) {
            return row == position.row && column + 1 == position.column;
        }
        ...
        public Position Left() {
            if (column == 0) throw new InvalidOperationException("The required position is not accessible");
        ...
        public bool IsRight(Position position) {
            return row == position.row && position.column + 1 == column;
        }
        ...
        public Position Right() {
            if (column + 1 == Int32.MaxValue) throw new InvalidOperationException("The required position is not accessible");
